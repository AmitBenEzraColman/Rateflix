package com.example.rateflix.modules.newReview
...
import com.example.rateflix.databinding.FragmentNewReviewBinding
import com.example.rateflix.modules.tvShow.TvShowFragmentArgs
...
class NewReview : Fragment() {
    ...
    private fun defineUploadButtonClickListener() {
        binding.uploadButton.setOnClickListener {
            ...
            viewModel.createReview(args.selectedTvShow.title) {
